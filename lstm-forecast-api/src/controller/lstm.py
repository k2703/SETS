...
class LSTMSeries:
    """
        ...
        It automatically predicts the next value of a time series, manages observations 
        and inverts normalizations as expected.
    """
    ...
    def load_model(self, model_name):
        """
            Loads model
        """
        home_dir = os.path.dirname(os.getcwd()).replace(' ','\ ')+ LSTMSeries.MODEL_PATH
    ...
    def load_scaler(self, scaler_name):
        ...
        """
        home_dir =os.path.dirname(os.getcwd()).replace(' ','\ ')+ LSTMSeries.DATA_PATH
